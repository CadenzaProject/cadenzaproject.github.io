...
An important issue to be aware of is the possibility of the hearing aid producing signals with an amplitude that causes clipping. This happens for some of out samples in the baseline (because our baseline is very simple!).

More details can be found in the [core software](cc1_core_software) page.

#### 2.1.1 Enhancement Procedure

The enhancement procedure goes as follows:

1. Computes the level in dB LUFS of the original song, i.e., the song from the dataset.
