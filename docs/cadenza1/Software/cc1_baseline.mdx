...
These later signals form the reference VDBO signals that are needed for the objective evaluation using HAAQI [1].
...
The car noise to be added will be provided by a simple simulator of noise in a car cabin.
...
In enhancement, the baseline system simply normalise the signal accordingly to the average audiogram of the ear with
greater hearing loss. The system attenuates the signal and save it in 16 bits.
