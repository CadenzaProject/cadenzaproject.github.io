...
- **Feb 1st**: "Beta" version of evaluation data release for HASPI evaluation for all entrants.
- **March 1st**: Evaluation data release for HASPI evaluation for all entrants.
- **tbc**: Registration deadline.
- **Sept 1st**: All entrants submit (i) audio for HAAQI evaluation and (ii) a draft of their technical report.
- **Sept 1st**: Deadline by which all entrants must submit two page technical reports to Clarity-2022 workshop.
- **Sept 1st**: Entrants informed which systems are going forward to the listening test evaluation stage. Evaluation data for listening tests released to those entrants.
