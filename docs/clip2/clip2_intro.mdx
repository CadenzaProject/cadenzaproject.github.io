...
We are now excited to announce the launch of the second Cadenza lyric intelligibility prediction challenge CLIP2, which builds on CLIP1
...
The CLIP2 dataset is a collection of thousands of music excerpts extracted from AI-generated songs created in collaboration with [ElevenLabs](https://elevenlabs.io).
