...
* `cadenza_clip2_data.train.v1.0.tar.gz` [4.5GB]: labelled training data.
* `cadenza_clip2_data.valid.v1.0.tar.gz` [576MB]: unlabelled validation data.

:::tip[Demo data]
If you need to have a quick view of the data structure, we also provide a demo package:
* `cadenza_clip2_data.demo.v1.0.tar.gz` [4MB]
...
* Notes:
  ...
  * Slight misalignment and variations in the number of frames may occur between the signal audio and the unprocessed audio due to the hearing loss simulation.
