...
Please mind that you will receive your `TEAM_ID` after the submission windows open. This will be sent to the same email account you use during registration.
...
Pairs of processed and unprocessed audio signals will be provided together with their metadata using the same fields as the validation dataset.
It won't contain the listener's correctness score or their responses.
We will score your submission for you and return your score (we aim to do this within 48 hours of submission).

:::warning[release of the Evaluation Data]
See [Key Dates](../key_dates) to check when evaluation data will be released.
:::

[//]: # (To get access to the data, please download the package from the Zenodo repository:)

[//]: # ()
[//]: # (* `cadenza_clip2_data.eval.v1.0.tar.gz` [561 MB]: unlabelled evaluation data.)

[//]: # (* [Zenodo link]&#40;https://zenodo.org/records/20413050&#41; Version 1.2.0)
...
We will score your submission for you and return your score (we aim to do this within 48 hours of submission).
This extra information can then be included in a revised version of your report, which will be published on our website in time for ICASSP 2027 on May.

## Where should I submit my entry?

The CSV files and the technical report should be submitted using the following form:<br />
[Submission Form](https://forms.gle/NPAF6w5jcfghBGVR7)
...
e.g. if your `<TEAM_ID>` is T001 use the names `ICASSP2027_valid_T001a.csv` and `ICASSP2027_valid_T001b.csv` for the validation set. Same structure for the evaluation set.
