...
- The [CLIP1](../../clip1/data/data) dataset for training and validation.
   - Note, CLIP1 test set **cannot** be used for training or validate your model.
- Their own data for training or expand the CLIP1 and CLIP2 training data through simple automated modifications. 
...
If your system incorporates Audio2 and/or ground-truth text, please submit results with and without these components whenever possible. 
