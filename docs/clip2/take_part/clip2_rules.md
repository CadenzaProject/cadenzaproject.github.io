...
1. The [CLIP1](../../clip1/data/data) for training and validation.
   - CLIP1 test set **cannot** be used for training or validate your model.
2. Their own data for training or expand the CLIP2 training data through simple automated modifications. 
3. Additional pre-training data could be generated by existing speech intelligibility, lyric intelligibility and hearing loss models. The [FAQ](./FAQs) gives links to some models that might be used for this.
