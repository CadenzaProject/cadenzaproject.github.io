...
1. Download and install PyClarity as described in [Download data and software](../take_part/download).
2. Download and extract the **core** data packages as described in [Download data and software](../take_part/download). 
